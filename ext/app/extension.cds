...
extend db.Assessments with  {
  x_status      : Association to one x_Status @title: 'Status' @Common.Text : x_status.name  @Common.TextArrangement : #TextOnly;
  x_priority    : Association to one x_Priority @title: 'Priority' @Common.Text : x_priority.name  @Common.TextArrangement : #TextOnly;
  x_contact     : Association to one db.Users  @title: 'Contact' @Common.Text : x_contact.fullName  @Common.TextArrangement : #TextOnly;
  x_validFrom   : Date @title: 'Valid From';
  x_validTo     : Date @title: 'Valid To';
  x_notes       : String @title: 'Note';
}
