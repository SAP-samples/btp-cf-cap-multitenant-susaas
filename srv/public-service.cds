...
service PublicService @(path : '/catalog/PublicService') {
  ...
  entity SalesOrders as projection on db.SalesOrders excluding {
    createdAt,createdBy,modifiedAt,modifiedBy
  }
  ...
  entity RecyclingCountries as projection on db.RecyclingCountries excluding {
    createdAt,createdBy,modifiedAt,modifiedBy
  }

  entity RecyclingMaterials as projection on db.RecyclingMaterials excluding {
    createdAt,createdBy,modifiedAt,modifiedBy
  }
