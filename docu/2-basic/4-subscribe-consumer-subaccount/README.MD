# Subcribe a Consumer Subaccount
...
1.1. Create a new subaccount for your SaaS consumer. Make sure the subaccount is in the same region as the provider subaccount (e.g. us10). 
